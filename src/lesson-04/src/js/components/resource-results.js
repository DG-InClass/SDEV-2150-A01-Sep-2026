...
class ResourceResults extends HTMLElement {
  ...
  set filters(filters) {
    // Retail ALL existing filter values unless explicitly overridden
    this.#filters = {
      ...this.#filters, // using the spread operator ...
      ...filters, // whatever properties are inside of filters are being placed here
    };
    this.#applyFilters();
  }
